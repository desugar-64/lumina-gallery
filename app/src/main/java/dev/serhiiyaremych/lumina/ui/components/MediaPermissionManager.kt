...
class MediaPermissionManager(
    ...
    fun checkPermissionStatus(): MediaPermissionStatus {
        return detectActualPermissionState()
    }
    
    private fun getPermissionState(permission: String): MediaPermissionState {
    ...
    private fun detectActualPermissionState(): MediaPermissionStatus {
