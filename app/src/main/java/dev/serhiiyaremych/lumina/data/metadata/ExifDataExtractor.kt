...
class ExifDataExtractor @Inject constructor(
    ...
    private fun extractTechnicalMetadata(exif: ExifInterface): MediaMetadata.TechnicalMetadata = MediaMetadata.TechnicalMetadata(
    ...
    private fun extractAdvancedMetadata(exif: ExifInterface): MediaMetadata.AdvancedMetadata = MediaMetadata.AdvancedMetadata(
    ...
    private fun formatDateTime(dateTime: String): String = try {
